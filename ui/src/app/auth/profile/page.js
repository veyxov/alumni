  ...
  return (
    <div className="mb-6">
      <div className="inline-flex gap-2 items-center justify-center">
        ...
        {data.isCurrent ? (
          <div className="mt-2 bg-green-100 p-1 rounded text-green-700">
            Current
          </div>
        ) : (
          <div className="mt-2 bg-red-100 p-1 rounded text-red-700">
            Not current
          </div>
        )}
      </div>
...
function Profile({ data }) {
  ...
  return (
    <div className="flex gap-3 ml-4">
      <div className="w-1/3">
        <img
          className="w-full h-44 bg-blue-100 mt-4"
      ...
      <div className="w-2/3 ml-2">
        <div>
          <div>
            <div className="mt-2 text-black sm:text-sm md:text-xl lg:text-2xl text-primary capitalize font-extrabold">
              {data.name}
            </div>
        ...
        <div className="mt-8 flex flex-row gap-2">
          <button className="mt-2 rounded p-3 bg-blue-100 text-black">
            Send message
          </button>
          <button className="mt-2 rounded p-3 bg-blue-300 text-blue-500">
            Contacts
          </button>
          <Link
            href="/auth/profile/edit"
            className="mt-2 rounded p-3 bg-gray-300 text-gray-700"
          >
            Report
          </Link>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="mx-4 my-8">
            ...
            <div className="mt-2 text-gray-500">Birthday: {data.birthday}</div>
          </div>
        </div>
      </div>
    </div>
